...
import { ALL_PRODUCTS } from '../data/tabletList';
...
const Tablets: React.FC = () => {
  ...
  const allProducts: Product[] = useMemo(() => {
    return ALL_PRODUCTS.flatMap(category => 
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 py-2 md:py-2">
        <div className="container mx-auto px-4 flex items-center justify-between">
          ...
          <div className="bg-black text-yellow-400 px-3 py-2 md:px-8 md:py-4 rounded-lg">
            <h2 className="text-xl md:text-4xl font-bold">TABLETS</h2>
          </div>
        </div>
      </div>
